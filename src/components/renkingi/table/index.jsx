...
export default function TableAdd({ onClickDelete , onClickPut , onClickAddAbout}) {
  const ClientCommentGetState = useSelector(state => state.renkingi.RenkingiGet?.data)
        ...
        <TableBody>
          {ClientCommentGetState.map((row) => (
            ...
            >
              ...
              <TableCell component="th" scope="row">
              <button style={{background : "green" , color:"white", padding:"10px", border : "none" , cursor :"pointer"}} id={row.id} onClick={onClickAddAbout}>	информация о рейтинге Добавить</button>
              </TableCell>
