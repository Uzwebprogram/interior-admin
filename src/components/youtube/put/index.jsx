      ...
      <ModalCommon width={340} open={openPut} handleClose={handleClosePut}>
        <Wrapper>
          ...
          <form onSubmit={HandleSubmit}>
            {data.getYoutube?.Data.map((elem) =>
              elem.tube_id == HandlePut ? (
                <>
                  <input
                    type="text"
                    ref={titleUz}
                    placeholder={elem.tube_title_uz}
                  />
                  <input
                    type="text"
                    ref={titleRu}
                    placeholder={elem.tube_title_ru}
                  />
                  <input
                    type="text"
                    ref={titleEn}
                    placeholder={elem.tube_title_en}
                  />
                  <input
                    type="text"
                    ref={titleVideo}
                    placeholder={elem.tube_video}
                  />
