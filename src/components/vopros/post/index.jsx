...
import { VoprosGet, VoprosPost , UploadImage } from '../../../redux/vopros';
function AdminAddForm({Open , HandleClose}) {
    ...
    const dataClient = useSelector(state => state.vopros.uploadImages)
    ...
    const HandleSubmit = async (e) =>{
        ...
        await dispatch(VoprosPost(body))
        dispatch(VoprosGet())
        HandleClose()
      }
  ...
  return (
    <ModalCommon height={370} width={400} open={Open} handleClose={HandleClose}>
          ...
          <Wrapper onSubmit={HandleSubmit}>
              ...
              <input type="text" placeholder='название категории' required ref={CategoryNameRef} />
