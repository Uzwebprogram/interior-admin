...
import { VoprosPut , UploadImage, VoprosGet} from "../../../redux/vopros";
...
function Put({ openPut, handleClosePut, HandlePut }) {
  ...
  const data = useSelector(state => state.vopros?.VoprosGet?.data)
  ...
  const HandleSubmit = async (e) => {
    ...
    await dispatch(VoprosPut({ body, id: HandlePut }));
    dispatch(VoprosGet());
    handleClosePut();
  };
  return (
