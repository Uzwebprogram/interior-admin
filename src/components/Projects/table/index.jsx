          ...
          {ClientCommentGetState.map((row) => (
            ...
            >
              <TableCell component="th" scope="row">
                <img src={row.project_img} width={60} height={60}  alt="" />
              </TableCell>
              <TableCell component="th" scope="row">
                {row.project_title_ru}
              </TableCell>
              <TableCell component="th" scope="row">
                {row.project_description_ru}
              </TableCell>
              <TableCell align="right"><button style={{background : "white" , border : "none" , cursor :"pointer"}} id={row.project_id} onClick={onClickPut}><img id={row.project_id} src={Put} width={25} height={25} alt="" /></button> <button style={{background : "white" , border : "none" , cursor :"pointer"}} id={row.project_id}  onClick={onClickDelete}><img id={row.project_id} src={Delete} width={25} height={25} alt="" /></button></TableCell>
              </TableRow>
          ))}
        </TableBody>
      </Table>
