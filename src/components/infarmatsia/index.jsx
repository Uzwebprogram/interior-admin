...
import { InfarmatsiaDelete, InfarmatsiaGet } from '../../redux/infarmatsia';
import Delete from './delete';
import AdminAddForm from './post';
import Put from './put';
import TableAdd from './table';
function InfarmatsiaComponent({open , handleClose}) {
  ...
  const HandleDelete =  async() =>{
    await dispatch(InfarmatsiaDelete(adminId))
...
export default InfarmatsiaComponent