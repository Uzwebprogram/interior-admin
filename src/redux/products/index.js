...
export const PostProducts = createAsyncThunk("Products/post" , async (body) =>{
    return await axios.post(`${API_URL}/products` , body)
    .then(res => res)
})
...
export const UploadImage3 = createAsyncThunk("Products/upload2" , async (e) =>{
    const formData = new FormData()
    formData.append("file" , e.target.files[0])
    formData.append("upload_preset" , "jlgbmu1o")
        try{
...
export const UploadImage4 = createAsyncThunk("Products/upload2" , async (e) =>{
    const formData = new FormData()
    formData.append("file" , e.target.files[0])
    formData.append("upload_preset" , "jlgbmu1o")
        try{
...
export const PutProducts = createAsyncThunk('Products/put' , async({body , id})=> {
    console.log(id , body);
    return await axios.put(`${API_URL}/products/${id}`, body)
